# Generated by Django 5.1.2 on 2024-10-13 03:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiry_date',
                 models.DateTimeField(blank=True, help_text='Once API key expires, clients cannot use it anymore.',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_logout_redirect_uris',
                 models.TextField(blank=True, default='', help_text='Allowed Post Logout URIs list, space separated')),
                ('client_type',
                ...
                ('allowed_origins', models.TextField(blank=True, default='',
                                                     help_text='Allowed origins list to enable CORS, space separated')),
                ('scope', models.TextField(blank=True)),
                ('type', models.CharField(blank=True,
                                          choices=[('system', 'The applications created by Pandosima Company'),
                                                   ('third-party', "The third-parties's applications"),
                                                   ('client', 'The application created by the bussiness')],
                                          default='client', max_length=50)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code_challenge_method',
                 models.CharField(blank=True, choices=[('plain', 'plain'), ('S256', 'S256')], default='',
                                  max_length=10)),
